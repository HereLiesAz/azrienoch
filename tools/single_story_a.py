...
-- most grotesques draw 'a' as a double-story letterform, a
printed-book convention rather than how people actually write it by
...
This separation keeps things simple: the stem is contour 0 outright, a
4-point rectangle, so shortening it is just moving its two top points
down, no search needed.
"""
